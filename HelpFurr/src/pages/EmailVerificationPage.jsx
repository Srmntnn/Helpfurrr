        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex justify-between">
              {code.map((digit, index) => (
                <input
                  ...
                  className="sm:w-12 w-10 md:h-12 h-10 transition duration-200 text-center md:text-2xl text-lg font-bold bg-light-orange text-main-brown border border-secondary-brown rounded-md focus:border-main-orange focus:outline-none"
                />
              ))}
            </div>
            {error && (
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-secondary-orange cursor-pointer to-main-orange text-light-orange font-bold py-3 px-4 rounded-lg shadow-lg hover:from-main-orange hover:to-secondary-orange focus:outline-none focus:ring-2 focus:ring-main-orange focus:ring-opacity-50 disabled:opacity-50 fredoka-bold tracking-wider"
            >
