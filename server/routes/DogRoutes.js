...
const { getAllDogs, PostDogRequest, deletePost, approveRequest, getDogsById, getDogByEmail, getAllDogData, rejectDog, editDog, AddDog } = require('../controllers/dogsController');
